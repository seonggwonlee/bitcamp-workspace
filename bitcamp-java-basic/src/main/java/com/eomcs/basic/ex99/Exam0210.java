...
public class Exam0210 {
  public static void main(String[] args) {
    ...
    java.io.InputStream keyboard = System.in; // 입력 스트림
    ...
    // => 키보드를 스캐너에 연결한다.
    // 도구 중 재료가 있어야만 쓸 수 있는 것들과 없어도 쓸 수 있는 것들이 있다.
    // 재료 없어도 쓸 수 있는 도구 currentTimeMillis
    // 재료(데이터)가 있어야 쓸 수 있는 도구 : Scanner
    ...
    //   static이 붙는 것들은 기본 데이터가 없어도 된다.
    //   static이 붙지 않은 것들은 기본 데이터가 반드시 필요하다.
    String str = keyScan.nextLine(); // nextLine은 Scanner에만 있는 도구인데, 입력 스트림이 한 개가 아니기 때문에 Scanner가 바로 올 수는 없다. 입력 스트림에 대한 정보가 필요하다.
