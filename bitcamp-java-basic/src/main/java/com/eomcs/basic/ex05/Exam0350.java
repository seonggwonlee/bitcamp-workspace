...
// 즉 24비트(3바이트)로 픽셀 색상을 표현하는 것이다. (RGB 각각 8비트 씩)
...
// -------------------------------
//    10001000 10010000 10101100 (변경 후)
//
// 비트 연산 활용 예3:
// => 흑백을 반전시킨다.
// 방법: 
//  - 빛이 있는 도트에 빛을 없애고, 빛이 없는 도트에 빛을 넣는다. (1 => 0 / 0 => 1)
//
// => 다음과 같이 흑색의 한 개의 도트 있다.
//    00000000 00000000 00000000 (변경 전 => 흑색)
//  ~ 
// -------------------------------
//    11111111 11111111 11111111 (변경 후 => 흰색)
//
//
// 비트 연산 활용 예4:
// => 특정 색상만 제거하기
// 방법 
// - ^ 연산자 사용하여 특정 색상만 제거할 수 있다.
//
// => 다음과 같이 비트 데이터가 있다.
...
// => 하나의 도트에 대해 연산한 출력 결과가 0이면 해당 도트의 색상을 제거하고
